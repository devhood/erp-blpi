...
class Address extends \Database\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'addressId', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'addressType', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'streetLandmark', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'zipcode', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'recordStatus', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'country', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'customer', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'city', '' . "\0" . 'Database\\Entity\\Address' . "\0" . 'province');
        }

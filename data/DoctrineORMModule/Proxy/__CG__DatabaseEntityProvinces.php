 ...
 */
class Provinces extends \Database\Entity\Provinces implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Database\\Entity\\Provinces' . "\0" . 'provinceId', '' . "\0" . 'Database\\Entity\\Provinces' . "\0" . 'provinceName', '' . "\0" . 'Database\\Entity\\Provinces' . "\0" . 'countryId', '' . "\0" . 'Database\\Entity\\Provinces' . "\0" . 'recordStatus');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Provinces $proxy) {
    ...
    public function getProvinceId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getProvinceId();
        }
    ...
    public function setProvinceName($provinceName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProvinceName', array($provinceName));

        return parent::setProvinceName($provinceName);
    }
    ...
    public function getProvinceName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProvinceName', array());

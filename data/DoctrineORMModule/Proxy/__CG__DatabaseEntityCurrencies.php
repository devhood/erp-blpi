 ...
 */
class Currencies extends \Database\Entity\Currencies implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Database\\Entity\\Currencies' . "\0" . 'currencyId', '' . "\0" . 'Database\\Entity\\Currencies' . "\0" . 'currencyName', '' . "\0" . 'Database\\Entity\\Currencies' . "\0" . 'recordStatus');
        }

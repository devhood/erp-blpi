 ...
 */
class Countries extends \Database\Entity\Countries implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Database\\Entity\\Countries' . "\0" . 'countryId', '' . "\0" . 'Database\\Entity\\Countries' . "\0" . 'countryName', '' . "\0" . 'Database\\Entity\\Countries' . "\0" . 'recordStatus');
        }

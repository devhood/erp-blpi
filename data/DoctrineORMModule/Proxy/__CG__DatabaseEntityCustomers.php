...
class Customers extends \Database\Entity\Customers implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'customerId', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'companyName', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'branch', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'tradeName', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'tin', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'phone', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'email', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'website', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'secNo', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'consignee', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'franchisee', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'creditLimit', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'transactionLimit', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'percentCommission', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'customerStatus', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'priceType', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'paymentTerm', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'category', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'customerType', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'salesExecutive', '' . "\0" . 'Database\\Entity\\Customers' . "\0" . 'shippingMode');
        }
